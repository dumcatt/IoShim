...
For DirectInput keyboard emulation, you will need to install [Interception](https://github.com/oblitum/Interception) and run the app as Admin for it to work.

More game I/O support coming soon
