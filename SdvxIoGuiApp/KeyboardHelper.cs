...
namespace SdvxIoGuiApp
{
    public static class KeyboardHelper
    {
        ...
        public static bool TryParseKey(string keyName, out ushort vkCode)
        {
            vkCode = GetVkCode(keyName);
            return vkCode != 0;
        }

        public static void PressKey(ushort vkCode, string keyName, bool useInterception = false)
        {
            SendKey(vkCode, keyName, true, useInterception);
        }

        public static void ReleaseKey(ushort vkCode, string keyName, bool useInterception = false)
        {
            SendKey(vkCode, keyName, false, useInterception);
        }
